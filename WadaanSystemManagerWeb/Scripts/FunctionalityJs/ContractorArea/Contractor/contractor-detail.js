...
function LoadContractorDetail() {
    ...
    KendoGlobalAjax({ commandName: 'Contractor_SelectDetailByID', values: { ContractorID: id }, CallBack: loadContractorDetailsByID });
   // KendoGlobalAjax({ commandName: 'Images_SelectImagesByEmployeeID', values: "{EmployeeID:'" + id + "'}", CallBack: loadEmployeeImagesByID });


}
var loadContractorDetailsByID = function (d) {
    ...
    setTimeout(function () {
        ...
        console.log(d);
        $('.UserName').text(JSON.parse(d.Value)[0]["contractorName"]);
        $('.contractorName').text(JSON.parse(d.Value)[0]["contractorName"]);
        $('.contractorProvince').text(JSON.parse(d.Value)[0]['provinceID']);
        $('.contractorCity').text(JSON.parse(d.Value)[0]['cityID']);
        $('.phoneNo').text(JSON.parse(d.Value)[0]["phoneNo"]);
        $('.whatsApp').text(JSON.parse(d.Value)[0]["conWhatsApp"]);
        $('.email').text(JSON.parse(d.Value)[0]["conEmail"]);
        $('.houseNo').text(JSON.parse(d.Value)[0]["houseNo"]);
        $('.Street').text(JSON.parse(d.Value)[0]["streetNo"]);
...
//var loadEmployeeImagesByID = function (d) {
