...
var KendoGrid = function (_data) {
    ...
    var colModel = [
...

        {
            ...
            template: "<a class='viewbutton' style='font-size:15px;cursor:pointer;' onClick= LoadRecordByID(this)  title = 'Show Details' >#=contractorName#</a >",
        ...
        { field: "isActive", title: "IsActive", width: 170, filterable: true, hidden: true },
        {
            ...
            template: "   <a style='font-size:20px;cursor:pointer;' onClick= EditDetail(this) title='Edit Contractor' ><span class='fa fa-edit'></span></a>  <a class='btn btn-danger btn-sm text-white' onClick= deleteRecordByID('#=contractorID#')  >Deactivate</a>"
...
function LoadRecordByID(e) {
    ...
    window.location.href = '/Contractor/Contractor/ContractorDetail?contractorID=' + dataItem.contractorID + '';
}
...
function EditDetail(e) {
    ...
    var grid = $("#" + $grid).data("kendoGrid");
    var dataItem = grid.dataItem(row);
    window.location.href = '/Contractor/Contractor/Save?contractorID=' + dataItem.contractorID + '';
}
