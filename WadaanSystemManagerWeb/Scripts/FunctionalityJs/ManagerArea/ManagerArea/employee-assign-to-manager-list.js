...
function LoadRecordByID(e) {
    ...
    window.location.href = '/PROJECTMANAGERAREA/ProjectManager/EmployeeDetail?employeeID=' + dataItem.employeeID + '';
}
...
function EditDetail(e) {
    ...
    var grid = $("#" + $grid).data("kendoGrid");
    var dataItem = grid.dataItem(row);
    window.location.href = '/PROJECTMANAGERAREA/ProjectManager/EmployeeSave?employeeID=' + dataItem.employeeID + '';
}
