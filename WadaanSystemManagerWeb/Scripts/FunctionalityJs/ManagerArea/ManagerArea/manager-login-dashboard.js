...
var fnLoadMainDashbaordData = function (d) {
    ...
    $('#total-no-of-projects').text('( ' + JSON.parse(d.Value)[0].totalProjects + ' )' + ' ' + 'Projects');
...
// *  DONUT CHART HOVER EVENT WORK HERE ****
//var win = window.areaChart({
...
//        $('#dashboard-donut-chart .morris-hover-row-label').text(donut.data[i].label);
//        $('#dashboard-donut-chart .morris-hover-point').text(donut.data[i].value);
//    });
//}
// *  DONUT CHART HOVER EVENT WORK END ****
...
function drawChart3_1() {
    ...
    //dataTable.addRows([
    //    ['Project One', 'Task 1', new Date(2019, 3, 30), new Date(2021, 3, 30)],
    //    ['Project One', 'Task 2', new Date(2019, 2, 4), new Date(2020, 2, 4)],
    //    ['Project One', 'Task 3', new Date(2019, 2, 4), new Date(2020, 2, 4)],
