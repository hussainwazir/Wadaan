...
$(document).ready(function () {
    ...
    $('#btnSave').on('click', function (e) {
        ...
        $('#categoryTypeName').val($('#ProjectCategory option:selected').text());

        if ($('#ResidentialPlotSize').val() != '00000000-0000-0000-0000-000000000000') {
            $('#PlotSizename').val($('#ResidentialPlotSize option:selected').text());
        } else {
            $('#PlotSizename').val($('#CommercialPlotSize option:selected').text());
        }
        ...
        if ($('#ContractType').val() == '00000000-0000-0000-0000-000000000000') {
            Swal.fire({
                position: 'center',
                icon: 'info',
                title: 'Contract type is required...',
                showConfirmButton: false,
                timer: 1500
            });
            return;
        }
        if ($('#ProjectCategory').val() == '00000000-0000-0000-0000-000000000000') {
            Swal.fire({
                position: 'center',
                icon: 'info',
                title: 'Project category is required...',
                showConfirmButton: false,
                timer: 1500
            });
            return;
        ...
        if ($('#ProjectCategory option:selected').text() == 'Residential') {

            if ($('#ResidentialPlotSize').val() == '00000000-0000-0000-0000-000000000000') {
                Swal.fire({
                    position: 'center',
                    icon: 'info',
                    title: 'Residential plot size is required...',
                    showConfirmButton: false,
                    timer: 1500
                });
                return;
            ...
            if ($('#CommercialPlotSize').val() == '00000000-0000-0000-0000-000000000000') {
                Swal.fire({
                    position: 'center',
                    icon: 'info',
                    title: ' plot size is required...',
                    showConfirmButton: false,
                    timer: 1500
                });
                return;
        ...
        if (customvalidateForm('frmAddUpdateProject')) {
            ...
            var options = {
                success: function (response, statusText, jqXHR) {
                    ...
                    //  LoadEmployeesKendo();
                    window.location.href = '/Project/Project/Index';
                },
...
var fnLoadPriority = function (d) {
    BindComboForInt(JSON.parse(d.Value), $("#Priority"), "Select Priority");
}
...
var fnLoadNorthDDL = function (d) {
    BindComboForInt(JSON.parse(d.Value), $("#North"), "Select North");
}
...
var fnLoadEastDDL = function (d) {
    BindComboForInt(JSON.parse(d.Value), $("#East"), "Select East");
}
...
var fnLoadWestDDL = function (d) {
    BindComboForInt(JSON.parse(d.Value), $("#West"), "Select West");
}
...
var fnLoadSouthDDL = function (d) {
    BindComboForInt(JSON.parse(d.Value), $("#South"), "Select South");
}
...
var fnLoadSubStructureDDL = function (d) {
    BindComboForInt(JSON.parse(d.Value), $("#SubStructure"), "Select Contract Type");
}
...
var fnLoadSuperStructureDDL = function (d) {
    BindComboForInt(JSON.parse(d.Value), $("#SuperStructure"), "Select Super Structure");
}
...
var fnLoadFinishingDDL = function (d) {
    BindComboForInt(JSON.parse(d.Value), $("#Finishing"), "Select Finishing");
}
