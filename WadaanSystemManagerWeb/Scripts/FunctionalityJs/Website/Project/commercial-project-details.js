...
function LoadCommercialProjects() {
    ...
    KendoGlobalAjax({ commandName: 'Project_Select_For_WebsiteByID', values: { ProjectID: document.URL.split('/')[5] }, CallBack: fnLoadCommercialProjectDetails });
    KendoGlobalAjax({ commandName: 'Project_Select_Attachments_For_WebsiteByID', values: { ProjectID: document.URL.split('/')[5] }, CallBack: fnLoadCommercialProjectAttachment });

}


var fnLoadCommercialProjectDetails = function (d) {
 
    $('.txt-project-title').text(JSON.parse(d.Value)[0]["projectName"]);
    $('.ot_custom_heading').text("Commercial  | " +JSON.parse(d.Value)[0]["projectName"]); 
    $('.txt-project-title').text("Commercial  | " +JSON.parse(d.Value)[0]["projectName"]); 
...
var fnLoadCommercialProjectAttachment = function (d) {
