...
function LoadProjectKendo() {
    KendoGlobalAjax({ commandName: 'ProjectProgress_Select_AgainstClient', values: { UserID: userId }, CallBack: loadProjectsOfLoginClient });
}
...
var KendoGrid = function (_data) {
    ...
    var colModel = [
        ...
        { field: "sketch", title: "Sketch", width: 170, filterable: true },
        { field: "conceptDesign", title: "Concept Design", width: 170, filterable: true},
        { field: "submissionDrawing", title: "Submission Drawing", width: 170, filterable: true },
        { field: "dModeling", title: "3D Modeling", width: 170, filterable: true },
        { field: "structuralDrawing", title: "Structural Drawing", width: 170, filterable: true },
        { field: "architecture", title: "Architecture ", width: 170, filterable: true },
        { field: "elecricalDrawing", title: "Elecrical Drawing", width: 170, filterable: true },
        { field: "plumbingDrawing", title: "Plumbing Drawing", width: 170, filterable: true}
