...
namespace WadaanSystemManagerCommand.Installer
{
    public class CommandInstaller : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            ...
            logger.Info("Started: WadaanSystemManagerCommand::WadaanSystemManagerCommand.Installer.Services Install");
            container.Register(
            ...
            logger.Info("Ended: WadaanSystemManagerCommand.Services::WadaanSystemManagerCommand.Installer.Services Install");
        }
    }
}
